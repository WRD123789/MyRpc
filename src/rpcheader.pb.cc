...
const ::google::protobuf::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::myrpc::RpcHeader, servicename_),
  PROTOBUF_FIELD_OFFSET(::myrpc::RpcHeader, methodname_),
  PROTOBUF_FIELD_OFFSET(::myrpc::RpcHeader, argssize_),
};
...
const char descriptor_table_protodef_rpcheader_2eproto[] =
  "\n\017rpcheader.proto\022\005myrpc\"F\n\tRpcHeader\022\023\n"
...
::google::protobuf::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  ...
  "rpcheader.proto", &assign_descriptors_table_rpcheader_2eproto, 104,
};
